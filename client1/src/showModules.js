        ...
        setIsLoading(true);
         ...
         const supprimerElement = (element)=>{
          if(window.confirm("t'es sur ? ca va perdre cette infromation carrement ?")){
            ...
            console.log(element)
            Axios.delete(`http://localhost:3001/admin/sm/${element}` )
            .then(res => {
         ...
         const columns = [
            { dataField: 'idModule', text: 'Id',  sort: true ,  filter: textFilter()},
            { dataField: 'nomModule', text: 'Nom',  sort: true,  filter: textFilter() },
               ...
               formatter: (cellContent, row) => {
                 return (
                   ...
                   <button
                     ...
                     onClick={() => supprimerElement(row.idModule)}
                   >
                     Delete
                   </button>
                   ...
                   <a href={"/admin/mm/"+row.idModule}  className=" btn-warning " ><button>update</button></a>
